...
///////HUDs///////
	...
	if(href_list["interaction"])
		...
		var/hasvagina = (H.gender == FEMALE && H.dna.species.genitals && H.dna.species.id != "Unathi" && H.dna.species.id != "Stok")
		var/hasvagina_p = (P.gender == FEMALE && P.dna.species.genitals && P.dna.species.id != "Unathi" && P.dna.species.id != "Stok")
		...
		if (href_list["interaction"] == "bow")
			...
			if(((Adjacent(P) && !istype(P.loc, /obj/structure/closet)) || (H.loc == P.loc)) && hashands && !H.restrained() && P.dna.species.id == "Tajaran")
				if (prob(30))
...
/mob/living/carbon/human/proc/has_penis()
	if(gender == MALE && potenzia > -1 && dna.species.genitals && !mutilated_genitals)
		return 1
	else return 0
